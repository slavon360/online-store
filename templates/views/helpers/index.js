...
module.exports = function () {
	...
	_helpers.ifParent = function (a, b, options){
			var value;
			b.some(function(item,index){
	...
	_helpers.productSelfUrl = function(parentSlug, productSlug, options){
		return ('/product-categories/'+parentSlug+'/'+productSlug);
	}
    _helpers.productCategoryUrl = function (productSlug, options) {
		return ('/product-categories/' + productSlug);
	};
	...
	* */
	...
	_helpers.paginationNavigation = function (pages, currentPage, totalPages, pathname, options) {
		var html = '';
