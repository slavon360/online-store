...
function setActiveSortSaga() {
  var _ref3, path, _ref4, currentList, sort;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          _context3.next = 11;
          return (0, _effects.call)(_parsers.sortParser, path, currentList);
...
function setActiveFilterSaga() {
  var _ref5, filter, _ref6, currentList, activeFilters, updatedFilter;
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 11:
          ...
          _context4.next = 14;
          return (0, _effects.call)(_parsers.filterParser, filter, activeFilters, currentList);
...
function checkForQueryChange(nextProps, thisProps) {
  ...
  var parsedQuery = _extends({}, query, {
...
var takem =
/*#__PURE__*/
exports.takem = (0, _utils.deprecate)(take.maybe,
/*#__PURE__*/
(0, _utils.updateIncentive)('takem', 'take.maybe'));
...
var takeEvery =
/*#__PURE__*/
(0, _utils.deprecate)(_takeEvery2["default"],
/*#__PURE__*/
deprecationWarning('takeEvery'));
var takeLatest =
/*#__PURE__*/
(0, _utils.deprecate)(_takeLatest2["default"],
/*#__PURE__*/
deprecationWarning('takeLatest'));
var throttle =
/*#__PURE__*/
(0, _utils.deprecate)(_throttle2["default"],
/*#__PURE__*/
